...
if args.save :
    ...
    save_dir = '/scratch/gvignoud/results_succession/'+name_project+'/'+name_subproject+'/'+name_dir
...
n_pattern_list = np.arange(2, args.P, dtype=np.int)
